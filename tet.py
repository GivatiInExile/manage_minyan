...
def send_email(subject, msg):
    ...
    try:
        ...
        msg = MIMEMultipart()
        msg['Subject'] = '{}'.format(subject.format(quickstart.parsha))
        ...
        myid = get_msg_id(id_subj, id_toaddr)
        msg['Message-ID'] = myid
        #msg['To'] = COMMASPACE.join(config.RECIPIENT)
        ...
        #file = "minyan.png"
        try:
            #for file in /Users/daniellandesman/minyan_poetry/manage_minyan/PICS:
            with open(Minyan-overhead.png, 'rb') as fp:
                img = MIMEImage(fp.read())
                msg.attach(img)
        except:
            print("PICS NO WORKY")
